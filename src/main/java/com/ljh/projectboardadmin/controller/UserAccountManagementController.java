...
import com.ljh.projectboardadmin.dto.response.UserAccountResponse;
...
public class UserAccountManagementController {
    ...
    public String userAccounts(Model model) {
        model.addAttribute("userAccounts", userAccountManagementService.getUserAccounts().stream().map(UserAccountResponse::from).toList());
